$(document).ready(function () {
    ...
    function displayBooks(container, books) {
        ...
        books.forEach((book) => {
            const bookElement = `
                <div class="book">
                    <div class="book-content" data-id="${book.id}">
            ...
            success: function (data) {
                ...
                const selectedBookHtml = `
                    <div class="selectedBook">
                        <img src="${book.coverImage}" alt="book image">
                        <h1>${book.title}</h1>
                        <p><strong>Authors:</strong> ${book.authors.join(
                    ", "
                )}</p>
                        ...
                        <button id="closeBtn">Close</button> <!-- Close button at the bottom -->
                    </div>
                `;

                $("#selectedBook").html(selectedBookHtml).addClass("show-details");
                $("html, body").animate(
                    {
